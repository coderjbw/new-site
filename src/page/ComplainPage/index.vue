<template>
  ...
  <div class="complaint-page">
    ...
    <van-field
      ...
      readonly
      placeholder="选择投诉对象"
      v-model="selectResult.complaintTarget"
  ...
  <div class="complaint-page">
    ...
    <van-field
      type="textarea"
      v-model="selectResult.complaintReason"
      class="input-content"
      placeholder="输入投诉原因"
    />
  </div>
  ...
  <div class="complaint-page">
    ...
    <van-field
      type="textarea"
      class="input-content"
      v-model="selectResult.appeal"
      placeholder="点击输入处理诉求"
    />
  </div>
  <div class="complaint-page">
    <p class="title-text">
      最后，我们需要了解您的个人信息，用于核实事件以及告知您处理结果
    </p>
    <van-field
      label="你的姓名"
      placeholder="请输入姓名"
    ...
    <van-field
      ...
      type="tel"
      placeholder="请输入电话号码"
      v-model="selectResult.phoneNumber"
    />
    <van-field
      is-link
      readonly
