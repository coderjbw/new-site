<template>
    <div class="chat-message">
        ...
        <van-image width="120px" height="120px" radius="5" fit="cover" src="@/assets/kefu.png" />
        <!-- 大模型回复 -->
        <div class="ai-message">
            <!-- 通义千问回复的 -->
            <!-- <div class="mark-text">3333333</div> -->
            <div class="mark-text">
                <loadIng></loadIng>
            </div>
        </div>
        <!-- 火车票查询 -->
        <!-- <queryTrainTickets v-if="item.role == 'assistant' && item.functionName == 'trainTickets'" :fuction-data="item.toolData"></queryTrainTickets> -->
        <!-- 天气查询组件 -->
